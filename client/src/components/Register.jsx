...
const Register = () => {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      const url = `${window.location.origin}/api/users/register`; // Replace with your backend endpoint
      const method = "POST";
    ...
    <div className="bg-black min-h-screen h-full flex flex-col gap-5 items-center px-7">
      ...
      <div className="w-full flex flex-col max-w-[500px] min-w-[300px] mb-4">
        ...
        <div>
          ...
          <input
            type="text"
            className="px-4 mb-4 py-4 focus:outline-none w-full rounded bg-gray-800 text-white placeholder-red mb-1"
        ...
        <div className="py-3 flex gap-4 items-center justify-between">
          ...
          <button
            className={`bg-red-600 hover:bg-red-800 min-w-[80px] max-w-[70px] md:max-w-[120px] w-full text-white px-4 rounded-md h-10
      ...
      <div className="flex items-center flex-col gap-1 w-full">
        <button
          className={`bg-red-600 font-medium w-full text-white max-w-[400px] min-w-[300px] py-2 rounded-md px-4 ${loading || !userDescriptor || !username
        ...
        <p className="text-red-800 p-5 hovertext-red-900:">
